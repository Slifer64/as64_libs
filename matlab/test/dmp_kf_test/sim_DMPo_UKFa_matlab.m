...
path = strrep(mfilename('fullpath'), 'sim_DMPo_UKFa_matlab','');
...
%% Set up EKF object
ukf = unscentedKalmanFilter(@oStateTransFun, @oMsrFun, theta, 'HasAdditiveMeasurementNoise',true);
ukf.State = theta;
ukf.StateCovariance = P_theta;
ukf.ProcessNoise = Qn;
ukf.MeasurementNoise = Rn_hat;
ukf.Alpha = 0.001;
ukf.Beta = 2;
ukf.Kappa = 0;
