...
%% Plot results
figure('Position',[539 336 620 525]);
ax = subplot(3,1,1);
...
plot(Time, y_rev_data, 'LineWidth',2.5 ,  'LineStyle','--', 'Color',[0.85 0.33 0.1]);
legend({'$y$ - training','$y$ - novel', 'y - classical', 'y - reverse'}, 'interpreter','latex', 'fontsize',15, ...
...
legend({'$x$ - novel', '$x$ - classical'}, 'interpreter','latex', 'fontsize',15, 'Position',[0.6862 0.3627 0.2339 0.1004]);
ylabel('phase var', 'interpreter','latex', 'fontsize',15);
axis tight;
ax = subplot(3,1,3);
ax.Position = [0.1300 0.1100 0.7750 0.1546];
plot(Time, dist_data, 'LineWidth',2.5 ,  'LineStyle','-', 'Color','red');
legend({'$d(t)$'}, 'interpreter','latex', 'fontsize',15);
xlabel('time [$s$]', 'interpreter','latex', 'fontsize',15);
ylabel('disturbance', 'interpreter','latex', 'fontsize',15);
axis tight;
