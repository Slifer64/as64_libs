...
xlabel('y-axis [$m$]', 'interpreter','latex', 'fontsize',15);
ylabel('x-axis [$m$]', 'interpreter','latex', 'fontsize',15);

plot(ax.XLim, [0.72 0.72], 'LineWidth',2, 'LineStyle','--', 'Color',[1 0 0], 'HandleVisibility','off');
