...
for i=1:3
    subplot(5,1,i);
    hold on;
    plot([Time(1) Time(end)],[Yg(i) Yg(i)], 'LineStyle','--', 'Color','red' ,'LineWidth',2);
    plot(Time,Yg_data(i,:), 'LineStyle','-', 'Color','blue', 'LineWidth',linewidth);
    plot(Time,Y_data(i,:), 'LineStyle','-.', 'Color',[0 0.7 0], 'LineWidth',linewidth);
