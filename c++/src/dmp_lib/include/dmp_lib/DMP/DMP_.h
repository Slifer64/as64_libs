#ifndef AS64_DYNAMICAL_MOVEMENT_PRIMITIVE_ABSTRACT_H
#define AS64_DYNAMICAL_MOVEMENT_PRIMITIVE_ABSTRACT_H
...
namespace as64_
{
  ...
  namespace dmp_
  {
    ...
    public:
       ...
       */
      void train(const std::string &train_method, const arma::rowvec &Time, const arma::rowvec &yd_data,
                   const arma::rowvec &dyd_data, const arma::rowvec &ddyd_data, double *train_err);
       ...
       */
      void update(double x, double y, double z, double y0, double g, double y_c = 0.0, double z_c = 0.0);
       ...
       */
      double calcYddot(double x, double y, double dy, double y0, double g, double tau_dot=0, double yc=0, double zc=0, double yc_dot=0) const
      {
    ...
    protected:
      ...
      */
       ...
       */
      virtual double shapeAttractor(double x, double y0, double g) const = 0;
       ...
       */
      virtual double forcingTermScaling(double y0, double g) const = 0;
       ...
       */
      virtual double calcFd(double x, double y, double dy, double ddy, double y0, double g) const = 0;

      virtual double calcLearnedFd(double x, double y0, double g) const = 0;
...
#endif // AS64_DYNAMICAL_MOVEMENT_PRIMITIVE_ABSTRACT_H
