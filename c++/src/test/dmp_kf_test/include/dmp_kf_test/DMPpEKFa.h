...
#ifndef DMPpEKFa_EXTENDED_KALMAN_FILTER_AS64_H
#define DMPpEKFa_EXTENDED_KALMAN_FILTER_AS64_H
...
public:
  struct StateTransCookie
  {
    ...
    StateTransCookie(double t, const arma::vec &p0) { this->t = t;  this->p0 = p0; }
  };
   ...
   */
  DMPpEKFa(std::shared_ptr<dmp_::DMP_pos> dmp, double Ts);
...
#endif // DMPpEKFa_EXTENDED_KALMAN_FILTER_AS64_H
