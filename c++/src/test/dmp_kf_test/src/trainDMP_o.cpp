...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "train_dmp_o_node");
  ros::NodeHandle nh_("~");
  ...
  std::shared_ptr<dmp_::DMPo> dmp_o(new dmp_::DMPo(dmp_::TYPE::STD, N_kernels, a_z, b_z, can_clock_ptr, shape_attr_gat_ptr));

  // ===========  Train DMP  ===============
  std::cout << "DMP_o training...\n";
